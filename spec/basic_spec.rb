...
describe 'Reseller Club Models' do
  ...
  context "Testing Customer Model" do
    ...
    it "should generate a correct url for signup" do
      ...
      ResellerClub::Customer.signup("username" => "david@myownresellercompany.com", "passwd" => "marketleader", "name" => "David", "company" => "DavidCo", "address-line-1" => "96 st", "city" => "Miami", "state" => "FL", "country" => "US", "zipcode" => "55333", "phone-cc" => "186", "phone" => "55151155", "lang-pref" => "en", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for update" do
      ...
      ResellerClub::Customer.modify("username" => "david@myownresellercompany.com", "name" => "David", "company" => "DavidCo", "address-line-1" => "96 st", "city" => "Miami", "state" => "FL", "country" => "US", "zipcode" => "55333", "phone-cc" => "186", "phone" => "55151155", "lang-pref" => "en", "customer-id" => "5364", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for get_by_id" do
      ...
      ResellerClub::Customer.details_by_id("customer_id" => "5353", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for get_by_username" do
      ...
      ResellerClub::Customer.details("username" => "david@myownresellercompany.com", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for change_password" do
      ...
      ResellerClub::Customer.change_password("customer_id" => "8989", "new_passwd" => "password1", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for generate_password" do
      ...
      ResellerClub::Customer.temp_password("customer_id" => "8989", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for search" do
      ...
      ResellerClub::Customer.search("name" => "David", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for delete" do
      ...
      ResellerClub::Customer.delete("customer_id" => "5377", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for generate_token" do
      ...
      ResellerClub::Customer.generate_token("username"=>"david@myownresellercompany.com","passwd"=>"customerpassword", "ip"=>"1.1.1.1", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for authenticate token" do
      ...
      ResellerClub::Customer.authenticate_token("token" => "generatedtoken", :test_mock => true).should be_eql_url(org_url)
    end
  end
  ...
  context "Testing Contact Model" do
    ...
    it "should generate a correct url for add" do
      ...
      ResellerClub::Contact.add("name" => "Joe", "company" => "Registrants Inc", "email" => "joe@registrants.com", "address-line-1" => "main st no 41", "city" => "Chicago", "state" => "Illinois", "country" => "US", "zipcode" => "11500", "phone-cc" => "202", "phone" => "636518", "customer-id" => "8989245", "type" => "Contact", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for modify" do
      ...
      ResellerClub::Contact.modify("name" => "Joe Jr", "company" => "Registrants Inc", "email" => "joe@registrants.com", "address-line-1" => "main st no 41", "city" => "Chicago", "country" => "US", "zipcode" => "11500", "phone-cc" => "202", "phone" => "536585", "contact-id" => "25049249", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for details" do
      ...
      ResellerClub::Contact.details("contact_id" => "25050309", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for search" do
      ...
      ResellerClub::Contact.search("name" => "Joe Jr", "customer-id" => "8989245", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for default" do
      ...
      ResellerClub::Contact.default("type" => "Contact", "customer-id" => "8989245", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for delete" do
      ...
      ResellerClub::Contact.delete("contact_id" => "25049249", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for set_details" do
      ...
      ResellerClub::Contact.set_details("contact_id" => "25050309", "product-key" => "dotcoop", "attr-name1" => "sponsor1", "attr-value1" => "200", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for sponsors" do
      ...
      ResellerClub::Contact.sponsors("customer_id" => "8989245", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for coop_add_sponsor" do
      ...
      ResellerClub::Contact.coop_add_sponsor("name" => "Dave", "company" => "Registrants Inc", "email" => "dave@registrants.com", "address-line-1" => "main st no 41", "city" => "Chicago", "country" => "US", "zipcode" => "11500", "phone-cc" => "253", "phone" => "531531", "customer-id" => "8989245", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for dotca_registrantagreement" do
      ...
      ResellerClub::Contact.dotca_registrantagreement(:test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for validate_registrant" do
      ...
      ResellerClub::Contact.validate_registrant("contact_id" => ["50309", "1"], "eligibility-criteria" => ["CED_ASIAN_COUNTRY", "CED_DETAILS"], :test_mock => true).should be_eql_url(org_url)
    end
  end
  ...
  context "Testing Domain Model" do
    ...
    it "should generate a correct url for available" do
      ...
      ResellerClub::Domain.available("domain-name" => ["registrants"], "tlds" => ["com", "net"], :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for idn-available" do
      ...
      ResellerClub::Domain.idn_available("domain-name" => "españa", "tld" => "es", "idnLanguageCode" => "es", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for suggest_names" do
      ...
      ResellerClub::Domain.suggest_names("keyword" => "ipad", "tlds" => ["com", "net"], "hyphen-allowed" => "true", "add-related" => "true", "no-of-results" => "5", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for register" do
      ...
      ResellerClub::Domain.register("domain-name" => "domain.asia", "years" => "1", "ns" => ["ns1.domain.com", "ns2.domain.com"], "customer_id" => "8989245", "reg-contact-id" => "25052632", "admin-contact-id" => "25052632", "tech-contact-id" => "25052632", "billing-contact-id" => "25052632", "invoice-option" => "NoInvoice", "protect-privacy" => "true", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for validate_transfer" do
      ...
      ResellerClub::Domain.validate_transfer("domain_name" => "google.com", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for renew" do
      ...
      ResellerClub::Domain.renew("order-id" => "46983636", "years" => "1", "exp-date" => "1353825293", "invoice-option" => "NoInvoice", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for search" do
      ...
      ResellerClub::Domain.search("domain-name" => "registrants.com", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for customer_default_ns" do
      ...
      ResellerClub::Domain.customer_default_ns("customer_id" => "111", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for orderid" do
      ...
      ResellerClub::Domain.orderid("domain-name" => "domain.com", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for details" do
      ...
      ResellerClub::Domain.details("order-id" => "300", "options" => "OrderDetails", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for modify_ns" do
      ...
      ResellerClub::Domain.modify_ns("order-id" => "111", "ns" => ["ns1.domain.asia", "ns2.domain.asia"], :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for add_cns" do
      ...
      ResellerClub::Domain.add_cns("order-id" => "111", "cns" => "ns1.domain.com", "ip" => ["0.0.0.0", "1.1.1.1"], :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for modify_cns_name" do
      ...
      ResellerClub::Domain.modify_cns_name("order-id" => "555", "old-cns" => "ns1.domain.com", "new-cns" => "ns2.domain.com", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for modify_cns_ip" do
      ...
      ResellerClub::Domain.modify_cns_ip("order-id" => "777", "cns" => "ns1.domain.com", "old-ip" => "0.0.0.0", "new-ip" => "1.1.1.1", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for enable_theft_protection" do
      ...
      ResellerClub::Domain.enable_theft_protection("order-id" => "51", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for delete_cns_ip" do
      ...
      ResellerClub::Domain.delete_cns_ip("order-id" => "531", "cns" => "ns1.domain.asia", "ip" => "1.2.3.4", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for modify_contact" do
      ...
      ResellerClub::Domain.modify_contact("order-id" => "753", "reg-contact-id" => "1645316", "admin-contact-id" => "53146", "tech-contact-id" => "8361166", "billing-contact-id" => "6146", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for modify_privacy_protection" do
      ...
      ResellerClub::Domain.modify_privacy_protection("order-id" => "42323", "protect-privacy" => "true", "reason" => "somereason", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for modify_auth_code" do
      ...
      ResellerClub::Domain.modify_auth_code("order-id" => "564", "auth-code" => "authcode", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for disable_theft_protection" do
      ...
      ResellerClub::Domain.disable_theft_protection("order-id" => "53", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for locks" do
      ...
      ResellerClub::Domain.locks("order-id" => "65", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for tel_cth_details" do
      ...
      ResellerClub::Domain.tel_cth_details("order-id" => "65", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for tel_modify_whois_pref" do
      ...
      ResellerClub::Domain.tel_modify_whois_pref("order-id" => "573", "whois-type" => "Legal", "publish" => "y", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for resend_rfa" do
      ...
      ResellerClub::Domain.resend_rfa("order-id" => "65", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for uk_release" do
      ...
      ResellerClub::Domain.uk_release("order-id" => "5357", "new-tag" => "newregistrartag", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for cancel_transfer" do
      ...
      ResellerClub::Domain.cancel_transfer("order-id" => "536", :test_mock => true).should be_eql_url(org_url)
    end

    it "should generate a correct url for delete" do
      org_url = "https://test.httpapi.com/api/domains/delete.json?auth-userid=123456&auth-password=myresellerpass&order-id=536"
      ResellerClub::Domain.delete("order-id" => "536", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for restore" do
      ...
      ResellerClub::Domain.restore("order-id" => "560", "invoice-option" => "KeepInvoice", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for de_recheck_ns" do
      ...
      ResellerClub::Domain.de_recheck_ns("order-id" => "568", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for dotxxx_association_details" do
      ...
      ResellerClub::Domain.dotxxx_association_details("order-id" => "123", "association-id" => "123", :test_mock => true).should be_eql_url(org_url)
    end
  ...
  context "Testing Order Model" do
    ...
    it "should generate a correct url for suspend" do
      ...
      ResellerClub::Order.suspend("order-id" => "31", "reason" => "reason-for-suspension", :test_mock => true).should be_eql_url(org_url)
    end
    ...
    it "should generate a correct url for unsuspend" do
      ...
      ResellerClub::Order.unsuspend("order-id" => "31", :test_mock => true).should be_eql_url(org_url)
    end
